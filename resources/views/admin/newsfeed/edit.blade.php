...
@section('content')
    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <form action="{{ route('admin.newsfeed.update', ['newsfeed'=>$newsfeed->id]) }}" method="post" class="form-horizontal" enctype="multipart/form-data">
                ...
                <div class="form-row">
                    <div class="form-group col-md-5">
                        ...
                        <input type="datetime-local" name="publication_date" id="publication_date" class="form-control"
                               value="{{ old('publication_date', str_replace(" ","T",$newsfeed->publication_date) ?? '') }}">
                    ...
                    <div class="form-group col-md-5">
                        <label for="publication_date_stop">Data końca publikacji</label>
                        <input type="datetime-local" name="publication_date_stop" id="publication_date_stop" class="form-control"
                               value="{{ old('publication_date_stop',str_replace(" ","T",$newsfeed->publication_date_stop) ?? '') }}">
                ...
                <div class="form-row">
                    <div class="form-group col-md-12">
                        ...
                        <img src="{{ asset('storage/'. $newsfeed->photo) }}" height="100px" width="100px" class="float-left">
                    </div>
                </div>
                    ...
                    <div class="form-group col-md-12">
                        <div class="btn-toolbar" role="toolbar" aria-label="Toolbar with button groups">
                            <div class="btn-group mr-2" role="group" aria-label="First group">
                                <button type="submit" class="btn btn-success">Edytuj news</button>
                            </div>
